exports.default = {
  general: function(api){
    return {
      ...
      welcomeMessage: 'Hello! Welcome to the alligator metrics api',
      ...
      metrics:[
          // this is a list of alligator-metrics plugin names
          // metrics plugin still need to be included in `package.json` or the path defined in `api.config.general.paths.plugin`
      ],
